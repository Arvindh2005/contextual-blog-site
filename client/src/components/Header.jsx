...
const Header = () => {
  const { setInput, input, setResult } = useAppContext();
  ...
  const onSubmitHandler = async (e) => {
    e.preventDefault();
    try {
      const res = await fetch("http://localhost:8010/search", {
        method: "POST",
        headers: {
  ...
  return (
    <div className="mx-8 sm:mx-16 xl:mx-24 relative">
      ...
      <div className="text-center mt-20 mb-8">
        ...
        <p className="my-6 sm:my-8 max-w-2xl m-auto max-sm:text-xs test-gray-500">
